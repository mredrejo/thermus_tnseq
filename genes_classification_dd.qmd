...
```{r enrichment_pan, eval=FALSE,error=FALSE, fig.height=8, fig.cap=capFig("Significantly enriched KEGG Ontology groups made up of Less Permissive & Intermediate genes by KEGG ontology groups (A) or KEGG modules (B).")}
